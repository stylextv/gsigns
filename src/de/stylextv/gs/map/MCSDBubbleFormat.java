...
public class MCSDBubbleFormat extends MapColorSpaceData {
    ...
    public void writeTo(OutputStream stream) throws IOException {
        BitOutputStream bitStream = new BitOutputStream(BitOutputStream.setCompressionLevel(new GZIPOutputStream(stream), Deflater.BEST_COMPRESSION));
        try {
            ...
            System.out.println("Generating bubble spatial information...");
            for (int z = 0; z < 256; z++) {
                boolean[] strands = this.strands[z];
            ...
            System.out.println("Calculating bubble positions...");
            ...
            System.out.println("Initializing color information for " + bubbles.size() + " bubbles...");
            this.initColors();

            // Write cell information
            System.out.println("Writing bubble boundary information...");
            for (int z = 0; z < 256; z++) {
                writeSlice(z, bitStream);
            }

            // Write missing color information using bit encoding
            System.out.println("Correcting missing color information...");
    ...
    private void writeSlice(int z, BitOutputStream stream) throws IOException {
        ...
        System.out.println("Processing z=" + z + ", " + edges.size() + " edges, " + intersects.size() + " intersects, " + lines.size() + " lines"); 
